...
// WithClusterID adds the clusterID to the get account params
func (o *GetAccountParams) WithClusterID(clusterID string) *GetAccountParams {
	o.SetClusterID(clusterID)
	return o
}

// SetClusterID adds the clusterId to the get account params
func (o *GetAccountParams) SetClusterID(clusterID string) {
	o.ClusterID = clusterID
}

// WithUsername adds the username to the get account params
func (o *GetAccountParams) WithUsername(username string) *GetAccountParams {
	o.SetUsername(username)
	return o
}

// SetUsername adds the username to the get account params
func (o *GetAccountParams) SetUsername(username string) {
	o.Username = username
}
