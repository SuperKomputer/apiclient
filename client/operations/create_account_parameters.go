...
func (o *CreateAccountParams) WithAccount(account *models.Account) *CreateAccountParams {
	o.SetAccount(account)
	return o
}

// SetAccount adds the account to the create account params
func (o *CreateAccountParams) SetAccount(account *models.Account) {
	o.Account = account
}

// WithClusterID adds the clusterID to the create account params
func (o *CreateAccountParams) WithClusterID(clusterID string) *CreateAccountParams {
	o.SetClusterID(clusterID)
	return o
}

// SetClusterID adds the clusterId to the create account params
func (o *CreateAccountParams) SetClusterID(clusterID string) {
	o.ClusterID = clusterID
}

// WithUsername adds the username to the create account params
func (o *CreateAccountParams) WithUsername(username string) *CreateAccountParams {
	o.SetUsername(username)
	return o
}

// SetUsername adds the username to the create account params
func (o *CreateAccountParams) SetUsername(username string) {
	o.Username = username
}
