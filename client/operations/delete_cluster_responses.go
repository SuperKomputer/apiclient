...
func (o *DeleteClusterAccepted) Error() string {
	return fmt.Sprintf("[DELETE /clusters/{clusterId}][%d] deleteClusterAccepted ", 202)
}
...
func (o *DeleteClusterDefault) Error() string {
	return fmt.Sprintf("[DELETE /clusters/{clusterId}][%d] deleteCluster default  %+v", o._statusCode, o.Payload)
}
